...
# new findings by inspecting my particular FSK WAV file
# start about sample 3080, then take the 2 symbols.
# Looks like a good mark & space pair
# for purpose of bar graph it only takes 15 samples
...
n_bytes = n_frames * byte_per_sample
